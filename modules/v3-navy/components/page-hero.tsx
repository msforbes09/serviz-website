...
export function PageHero({
  ...
  return (
    <section className="bg-v3-navy relative overflow-clip text-white">
      ...
      />
      <div className="relative mx-auto max-w-[1200px] px-5 pt-18 pb-16">
        <p
        ...
        <h1
          ...
          className="font-outfit enter-rise enter-step mb-[18px] max-w-[760px] text-[clamp(36px,5.5vw,62px)] leading-[1.02] font-extrabold tracking-[-0.02em] text-pretty"
        >
          {title}
        </h1>
        {lede && (
          <p
            ...
            className="text-v3-on-dark enter-rise enter-step max-w-[620px] text-[17px] leading-[1.65] text-pretty"
          >
            {lede}
          </p>
        )}
